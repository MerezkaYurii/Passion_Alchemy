  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-1  bg-[#0f3995] border-[#0f3995] hover:bg-[#0f3995]/70 text-white font-light rounded-full shadow-xs hover:shadow-white transition-all  border duration-300"
      >
        <svg
        ...
        <span className="font-medium text-sm">{dict.header.language}</span>
      ...
      {/* Выпадающее меню */}
      {isOpen && (
        <div className="absolute right-0 mt-2 w-32 bg-gray-500 rounded-lg shadow-lg border border-gray-200 overflow-hidden z-50">
          {[
            ...
            <button
              ...
              className={`block w-full text-left px-4 py-2 text-sm hover:bg-gray-600  ${
                currentLocale === lang.code ? " font-medium bg-gray-800" : ""
              }`}
            >
              {lang.label}
            </button>
