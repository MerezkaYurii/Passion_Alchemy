      ...
      <div className="container mx-auto aspect-2/1 w-full overflow-hidden rounded-2xl relative bg-gray-200 dark:bg-gray-800 shadow-lg">
        ...
        <div className="absolute  left-1/2 -translate-x-1/2  bottom-4 z-30">
          <div className="flex items-center flex-col gap-1">
            ...
            <div className="block w-80    lg:w-200">
              <p className="text-xl sm:text-2xl lg:text-3xl font-medium italic text-white text-center  max-w-full py-0">
                {dict.HomePageSlider.title}
              </p>
              <p className=" text-lg sm:text-xl lg:text-2xl text-center  font-medium italic text-green-500  max-w-full py-0">
                {dict.HomePageSlider.desc1}
              </p>
              <p className=" text-lg sm:text-xl lg:text-2xl text-center  font-medium italic text-green-500  max-w-full py-0">
                {dict.HomePageSlider.desc2}
              </p>
            </div>
          </div>
        </div>
